...
interface DemoIf {
   ...
   * @return string
   */
  public function hello($thing);
}

class DemoClient implements \demo\DemoIf {
  ...
  public function hello($thing)
  {
    $this->send_hello($thing);
    return $this->recv_hello();
  }

  public function send_hello($thing)
  {
    $args = new \demo\Demo_hello_args();
    $args->thing = $thing;
  ...
  public function recv_hello()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\demo\Demo_hello_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \demo\Demo_hello_result();
...
class Demo_hello_args {
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('Demo_hello_args');
    if ($this->thing !== null) {
...
class Demo_hello_result {
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('Demo_hello_result');
